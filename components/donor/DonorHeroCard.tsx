...
const MENU_ITEMS = [
  ...
  { href: '/donors',    label: 'ডোনার খুঁজুন',       icon: 'M21 21l-6-6m2-5a7 7 0 1 1-14 0 7 7 0 0 1 14 0z' },
  { href: '/profile',   label: 'প্রোফাইল',            icon: 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z' },
  ...
  { href: '/privacy-policy', label: 'Privacy Policy', icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10zm0-7v-3m0-4h.01' },
        ...
        <nav className="flex-1 overflow-y-auto py-2">
          ...
          {(user?.role === 'superadmin' || user?.role === 'admin' || orgAdmins.length > 0) && (
            <>
              ...
              {orgAdmins.map((org) => (
                <Link key={org.id} href="/org-admin" onClick={() => setDrawerOpen(false)}
                  className="flex items-center gap-4 px-5 py-3.5 hover:bg-red-50 transition-colors group">
